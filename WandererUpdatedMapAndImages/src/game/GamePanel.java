...
class GamePanel extends JPanel implements KeyListener {
    ...
    public GamePanel() {
        try {
            mapImage = ImageIO.read(getClass().getResourceAsStream("resources/wandererMap.png"));
            collisionMap = ImageIO.read(getClass().getResourceAsStream("resources/mapCollision.png"));
            if (mapImage != null) {
        ...
        try {
            spriteSheet = ImageIO.read(getClass().getResourceAsStream("resources/FemaleSprites.png"));
        } catch (IOException | NullPointerException e) {
            spriteLoaded = false;
